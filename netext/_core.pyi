...
class CoreGraph:
    ...
    def router_update_node(self, node: Hashable, placed_node: PlacedRectangularNode) -> None: ...
    def router_update_edge(self, u: Hashable, v: Hashable, line: list[Point]) -> None: ...
